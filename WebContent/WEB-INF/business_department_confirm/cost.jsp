...
<table class="table table-hover definewidth m10">
    ...
    <tr>	
	    <td class="tableleft">效果图报销总金额（元）</td>
        <td><input type="text" name="cost"/></td>
		<td></td>
		<td></td>
	</tr>
	<tr>	
	    <td class="tableleft">效果图已摊销金额（元）</td>
        <td><input type="text" name="amotize"/></td>
	</tr>
	<tr>	
	    <td class="tableleft">本次摊销金额（元）</td>
        <td><input type="text" name="this_time_amotize"/></td>
	</tr>
	<tr>	
	   <td></td> 
	   <td></td> 
