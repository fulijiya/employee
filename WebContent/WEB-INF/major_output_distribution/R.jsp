...
<div class="content">
    <div class="dl-main-nav">
        ...
        <ul id="J_Nav"  class="nav-list ks-clear">
            <li class="nav-item dl-selected"><div class="nav-item-inner nav-home">专业产值分配</div></li>
...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'产值结算',items:[{id:'1',text:'管理产值分配',href:'manager_output_distribution/first.do'},{id:'1',text:'专业产值分配',href:'major_output_distribution/first.do'}]}]}];
